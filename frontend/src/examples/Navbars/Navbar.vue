    ...
    <div class="px-3 py-1 container-fluid">
      ...
      >
        ...
        <ul class="navbar-nav justify-content-end">
          <!-- Popover deshabilitado temporalmente para evitar errores de Popper.js -->
          <!--
          <li
          ...
          >
            <i
              class="fa fa-user ms-sm-2"
            ></i>
            <div
              ref="popoverContent"
              v-show="popoverVisible"
              class="popover bs-popover-buttom"
            >
              <div class="arrow"></div>
              <div class="popover-body">
                <table class="table">
                  ...
                  <tbody>
                    <tr v-for="(x, y) in infoByUser" :key="y">
                      <td>{{ x }}</td>
                    </tr>
                  </tbody>
                </table>
